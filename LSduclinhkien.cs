...
namespace D67
{
    public partial class LSduclinhkien : Form
    {

        public LSduclinhkien()
        {
            InitializeComponent();
        }

        private void LSduclinhkien_Load(object sender, EventArgs e)
        {
            ...
            txtSoLuongFirsrShot.Text = loadsoluongfirstshot.ToString();
            ...
            textBox1.Text = loadthoidiemthuctebatdausanxuat.ToString();
            txtThoiGianDungMay.Text = loadthoigiandungmay.ToString();
            txtTiLeHoatDongMay.Text = loadtilehoatdongmay.ToString();
