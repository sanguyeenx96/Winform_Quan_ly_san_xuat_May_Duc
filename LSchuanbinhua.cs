...
namespace D67
{
    public partial class LSchuanbinhua : Form
    {
        public LSchuanbinhua()
        {
            InitializeComponent();
        }

        private void LSchuanbinhua_Load(object sender, EventArgs e)
        {
            ...
            txtThoiGianVeSinhMaySayTieuChuan.Text = loadthoigianvesinhmaysaytieuchuan.ToString();
            txtTenNguyenLieuDuKienSuDung.Text = loadtennguyenlieudukiensudung.ToString();
            txtCapDoNguyenLieuDuKienSuDung.Text = loadcapdonguyenlieudukiensudung.ToString();
            txtMaMauNguyenLieuDuKienSuDung.Text = loadmamaunguyenlieudukiensudung.ToString();
            txtNhietDoSayDuKien.Text = loadnhietdosay.ToString();
            txtThoiGianSayDuKien.Text = loadthoigiansanxuatdukien.ToString();
            txtThoiGianSayDuKien.Text = loadthoigiansay.ToString();
            txtTiLeNhuaNghienTrenFile.Text = loadtilenhuanghientrenfile.ToString();
            txtLuongNhuaTinhCanDungDuKien.Text = loadluongnhuatinhcandungdukien.ToString();
            txtLuongNhuaNghienCanDungDuKien.Text = loadluongnhuanghiencandungdukien.ToString();
            ...
            txtThoiDiemDuKienBatDauSayNhua.Text = loadthoidiemdukienbatdausaynhua.ToString();
            txtThoiDiemThucTeBAtDauSAyNhua.Text = loadthoidiemthuctebatdausaynhua.ToString();
            txtThoiDiemDuKienBatDauVeSinhMaySay.Text = loadthoidiemdukienbatdauvesinhmaysay.ToString();
            txtThoiDiemThucTeBatDauVeSinhMaySay.Text = loadthoidiemthuctebatdauvesinhmaysay.ToString();
        }
    }
}
